...
# invoice.php
#
# Standard TFD Invoice 
#
# $Id: invoice.php,v 1.5 2002/10/16 06:52:58 youngd Exp $
#
...
if ($ordnumber) {
	...
	$invoiceid = $invidqu[0];
	$somesql = "SELECT id, invnumber, ordnumber, transdate, duedate, customer_id, netamount from ar where id = $invoiceid";
...
if ($ordnumber) {
	...
	echo '<tr bgcolor=acacac><td align=center><b>INVOICE</b></td></tr>';
	...
	echo '</table>';
	echo '<BR>';
	echo "<B>PAYMENT DUE BY: $billine[duedate]</B><BR>";
	echo 'LATE PAYMENT PENALTY AND/OR COLLECTION CHARGE MAY APPLY'; 
	echo '</td></tr>';
	echo '</table>';
	echo '</td></tr>';
	...
	echo '</table>';
	echo '</td></tr>';
	echo '<tr><td><br><b>COMMENTS:</b> For questions about this invoice, please call 
 847 283 0115.<br>';
 	echo '<br>';
	echo '</td></tr>';
	echo '<tr><td>';
	...
	echo "<tr bgcolor=ffffff><td><b>DUE DATE: $billine[duedate]</B></TD></TR>";
