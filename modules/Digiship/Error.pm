...
#
# $Id: Error.pm,v 1.1.1.1 2002/07/13 04:30:35 youngd Exp $
#
...
package Digiship::Error;

# Our name as it appears to other modules
my $name = 'Digiship Error Module';

# Our version, grab it from the CVS ID
my $cvsid   = '$Id: Error.pm,v 1.1.1.1 2002/07/13 04:30:35 youngd Exp $';
