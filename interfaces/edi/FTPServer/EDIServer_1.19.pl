...
#
# $Id: EDIServer_1.19.pl,v 1.1 2002/10/20 20:26:27 youngd Exp $
#
# Darren Young
# youngd@digiship.com
#
...
$cvsid = '$Id: EDIServer_1.19.pl,v 1.1 2002/10/20 20:26:27 youngd Exp $';
@cvsinfo = split(' ', $cvsid);
...
BEGIN {
       ...
       use ConfigReader;                # Config reader module
